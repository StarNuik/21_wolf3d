NAME = wolf3d
SRCS_DIR = srcs/
SRCS_LIST = read_audio.c audio.c raycast.c draw_wall.c entry.c init_sdl.c init.c exit.c read_textures.c read_map.c render.c pipe.c physics.c event_router.c
