...
/*   Updated: 2019/08/10 15:52:00 by sbosmer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_sdl(t_data *d)
{
	...
	d->sdl.win = SDL_CreateWindow("Wolf4dEAD", 500, SDL_WINDOWPOS_CENTERED,
		WIN_WIDTH, WIN_HEIGHT, SDL_WINDOW_OPENGL);
	d->sdl.ren = SDL_CreateRenderer(d->sdl.win, -1, SDL_RENDERER_ACCELERATED);
	d->sdl.tex_bg = SDL_CreateTexture(d->sdl.ren, SDL_PIXELFORMAT_ARGB8888,
		SDL_TEXTUREACCESS_TARGET, TEX_WIDTH, TEX_HEIGHT);
	d->sdl.tex_wall = SDL_CreateTexture(d->sdl.ren, SDL_PIXELFORMAT_ARGB8888,
		SDL_TEXTUREACCESS_TARGET, TEX_WIDTH, TEX_HEIGHT);
	d->sdl.tex_sprite = SDL_CreateTexture(d->sdl.ren, SDL_PIXELFORMAT_ARGB8888,
		SDL_TEXTUREACCESS_TARGET, TEX_WIDTH, TEX_HEIGHT);
	d->sdl.tex_gui_bg = SDL_CreateTexture(d->sdl.ren, SDL_PIXELFORMAT_ARGB8888,
		SDL_TEXTUREACCESS_TARGET, TEX_WIDTH, TEX_HEIGHT);
	d->sdl.tex_gui = SDL_CreateTexture(d->sdl.ren, SDL_PIXELFORMAT_ARGB8888,
		SDL_TEXTUREACCESS_TARGET, TEX_WIDTH, TEX_HEIGHT);
